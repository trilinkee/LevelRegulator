...
class BluetoothLeService : Service() {
    ...
    companion object {
        ...
        const val ACTION_GATT_CONNECTED = "com.trilinkee.bluetooth.le.ACTION_GATT_CONNECTED"
        const val ACTION_GATT_DISCONNECTED =
            "com.trilinkee.bluetooth.le.ACTION_GATT_DISCONNECTED"
        const val ACTION_GATT_SERVICES_DISCOVERED =
            "com.trilinkee.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED"
        const val ACTION_DATA_AVAILABLE = "com.trilinkee.bluetooth.le.ACTION_DATA_AVAILABLE"
        const val EXTRA_DATA = "com.trilinkee.bluetooth.le.EXTRA_DATA"
